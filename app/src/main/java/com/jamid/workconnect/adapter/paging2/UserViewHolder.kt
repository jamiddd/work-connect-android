...
class UserViewHolder(val view: View, val context: Context): RecyclerView.ViewHolder(view){
    ...
    private val userItemClickListener = context as UserItemClickListener
    ...
    companion object {
        ...
        @JvmStatic
        fun newInstance(parent: ViewGroup, context: Context) = UserViewHolder(LayoutInflater.from(parent.context).inflate(
            R.layout.user_horizontal_layout, parent, false), context)
    }
}