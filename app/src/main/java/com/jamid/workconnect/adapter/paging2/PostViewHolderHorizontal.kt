...
class PostViewHolderHorizontal(val view: View, actContext: Context): RecyclerView.ViewHolder(view) {

    private val postItemClickListener = actContext as PostItemClickListener
